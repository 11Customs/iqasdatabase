...
const config = {
  ...
  projectName: 'iqasdatabase', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                href: 'https://database.iq-a-s.com',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Database, IQ.A.S Inc. Built with Docusaurus.`,
      },
      prism: {
